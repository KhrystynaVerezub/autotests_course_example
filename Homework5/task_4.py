...
"""Объявляем функцию, которая принимает на вход слово word.
Создаем переменную points нулем.
Проходим циклом for по каждой букве в слове word.
Используя конструкцию if-elif-else, проверяем каждую букву и добавляем соответствующее
количество очков к переменной points. И возвращаем общее количество очков."""
