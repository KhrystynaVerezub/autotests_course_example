...
def segment(point1, point2):
    try:
        """Если ошибок нет, то эта строка возвращает сумму координат x и y каждой из точек.
        Эта функция вычисляет сумму всех четырех координат, и возвращает ее в качестве результата."""
        return point1[0] + point1[1] + point2[0] + point2[1]
    except Exception as e:  # задаем исключение переменной е
        return e.args[0][::-1]  # если возникла ошибка, то эта строка возвращает сообщение об ошибке, преобразованное в обратном порядке
